...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("smcho/ipinfo")
    client.subscribe("smcho/date")
    client.subscribe("smcho/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("smcho/ipinfo", on_message_from_ipinfo)

    client.message_callback_add("smcho/date", on_message_from_date)

    client.message_callback_add("smcho/time", on_message_from_time)
...
def on_message_from_ipinfo(client, userdata, message):
   print("IP Information  - IP Message: "+message.payload.decode())

def on_message_from_date(client, userdata, message):
   print("Date - Date Message: "+message.payload.decode())

def on_message_from_time(client, userdata, message):
   print("Time - Time Message: "+message.payload.decode())
