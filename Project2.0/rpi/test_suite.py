...
def collect_data():
    ...
    for i in range(num_samples):
        left  = mcp.read_adc(0)   # CH0 -> J2 left sensor
        right = mcp.read_adc(1)   # CH1 -> J3 right sensor
        avg   = (left + right) / 2
...
def run():
    ...
    # save graphs and CSV to output folder
    os.makedirs("output", exist_ok=True)
    fig1.savefig("output/left.png")
    fig2.savefig("output/right.png")
    fig3.savefig("output/avg.png")
